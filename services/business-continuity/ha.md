...
| Relational databases, such as medical records, phone books, and financial accounts. Application data for an e-commerce site. | * HTML files <br>JSON files<br>XML files | * Media files like photos, videos, audio<br>* Office file<br>* Text files, PDFs, TXT and RTF|
